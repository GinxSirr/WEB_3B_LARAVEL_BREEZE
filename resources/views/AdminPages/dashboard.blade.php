    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="text-sm text-gray-600">
                Total Users: <span class="font-semibold text-indigo-600">{{ $users->count() }}</span>
            </div>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          ...
          @if (auth()->user()->role === 'Admin')
              ...
              @else
              <div class="mb-6">
                  <p class="text-sm text-gray-500">You do not have permission to add new users.</p>
              </div>
          @endif
                ...
                <div class="p-6 border-b border-gray-200">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <div class="flex gap-2">
                            <input type="text" id="searchUsers" placeholder="Search users..." class="px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                        </div>
                    </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200" id="userTableBody">
                                @forelse($users as $user)
                                    <tr class="hover:bg-gray-50 transition-colors user-row">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $user->dob ?? 'N/A' }}</td>
                                        <td class="px-6 py-4 whitespace-nowrap">
